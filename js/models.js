...
class Story {
  ...
  constructor({ storyId, title, author, url, username, createdAt }) {
    ...
    this.createdAt = createdAt;
     async function toggleFavorite(user) {
      const endpoint = `${BASE_URL}/users/${user.username}/favorites/${this.storyId}`;
  ...
  getHostName() {
    // const inputUrl = $("#create-url").val();
    // const adjustedHostname = inputUrl.replace(/^https?:www\/\//i, '');
...
class StoryList {
  ...
  async addStory(user, newStory) {
    ...
    const newStoryInstance = new Story(storyData);
